...
function PaymentForm({ selectedSubscription }) {
  ...
  const [paymentFailed, setPaymentFailed] = useState(false); // New state variable
  ...
  const createSubscription = async () => {
    ...
    try {
      ...
      if (!paymentResponse.ok) {
        setPaymentFailed(true); // Set paymentFailed state to true
        setIsLoading(false)
        ...
        <>
          ...
          <div className="right_pay">
            ...
            {isLoading === true ? (
              ...
              <>
                {paymentFailed && <p>Please Try Again</p>} {/* Display "Please Try Again" if payment failed */}
                <button onClick={createSubscription}>Upgrade</button>
              </>
            )}
